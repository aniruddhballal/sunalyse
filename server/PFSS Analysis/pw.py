...
def process_carrington_map(carrington_map_number, lmax, fits_folder):
    fits_file = os.path.join(fits_folder, f'hmi.Synoptic_Mr_small.{carrington_map_number}.fits')
...
# ============================================================
carrington_map_number = 2096  # CR to process
...
# ============================================================
print("\n" + "="*60)
print("YOUR ORIGINAL ALM COMPUTATION CODE")
print("="*60)
print(f"Configuration:")
print(f"  CR Number:  {carrington_map_number}")
print(f"  lmax:       {lmax}")
...
try:
    process_carrington_map(carrington_map_number, lmax, fits_folder)
    print("\n" + "="*60)
    print("✓ PROCESS COMPLETE!")
    print("="*60)
    print(f"Output files:")
    print(f"  ALM values:  alm values/values_{carrington_map_number}.csv")
    print(f"  Error metrics: error metrics/error_{carrington_map_number}.csv")
    print(f"  Plot:        plots/plot_{carrington_map_number}.png")
    print("="*60 + "\n")
    
except FileNotFoundError:
    print(f"\n❌ ERROR: FITS file not found!")
    print(f"Looking for: {fits_folder}/hmi.Synoptic_Mr_small.{carrington_map_number}.fits")
    print(f"Make sure the file exists in the specified folder.")
